...
df = read.csv("/Users/davideyre/Drive/academic/research/transmission_modelling/cdiff_transmission_inference/xcode_project/sim_data/50_scenario_parms.csv")
...
for (parm in c("bgroundBeta", "wardBeta", "hospBeta", "spore.multiplier", "spore.p", "commBeta")) {
  ...
  print(p)
  ggsave(paste("50_scenarios_plot_parm_",parm,".pdf",sep=""), width = 29.7, height = 21.0, units = "cm")
}


## accuracy of source type attribution
df = read.csv("/Users/davideyre/Drive/academic/research/transmission_modelling/cdiff_transmission_inference/xcode_project/sim_data/50_scenario_src_type.csv")
...
for (scenario in unique(df$scenario_type)) {
  ...
  print(p)
  ggsave(paste("50_scenarios_plot_source_",scenario,".pdf",sep=""), width = 29.7, height = 21.0, units = "cm")
}


## accuracy of overall source type attribution
df = read.csv("/Users/davideyre/Drive/academic/research/transmission_modelling/cdiff_transmission_inference/xcode_project/sim_data/50_scenario_trans.csv")
df = merge(df, simlist, "simulation", all=T)
...
print (p)
ggsave("50_scenarios_plot_source_types.pdf", width = 29.7, height = 21.0, units = "cm")
...
print (p)
ggsave("50_scenarios_plot_sources.pdf", width = 29.7, height = 21.0, units = "cm")
...
print (p)
ggsave("50_scenarios_plot_inf_times.pdf", width = 29.7, height = 21.0, units = "cm")
